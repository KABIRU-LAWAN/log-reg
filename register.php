...
<body>
  <form action="functions/reg_function.php" method="POST">
    <div class="container">
      <?php
        ...
        if (isset($_GET['error'])) {
          ...
          if ($_GET['error'] == 'password-mismatch') {
            echo "<span class='error_message'>Passwords do not match</span>";
          }
          if ($_GET['error'] == 'user-exist') {
            echo "<span class='error_message'>Username or Email already registered</span>";
          }
          if ($_GET['error'] == 'weak-password') {
            echo "<span class='error_message'>The password is too weak</span>";
          }
        }
      ?>
      ...
      <label for="confirm_psw"><b>Repeat Password*</b></label>
      <input type="password" placeholder="Repeat Password" name="confirm_psw" id="confirm_psw" required>
      <hr>
